"""
Django settings for mondayuydgs_1 project.
...
ROOT_URLCONF = 'mondayuydgs_1.urls'
...
WSGI_APPLICATION = 'mondayuydgs_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mondayuydgs_1 API",
    "DESCRIPTION": "API documentation for mondayuydgs_1 App",
    "VERSION": "v1",
}
